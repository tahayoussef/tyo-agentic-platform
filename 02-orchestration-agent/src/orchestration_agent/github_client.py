...
Ported from 00/01 (kept self-contained per the platform's one-project-per-folder
convention). Only the handful of fields the agent reasons about are modelled; everything
else in the API response is ignored.
"""
...
_USER_AGENT = "tyo-orchestration-agent"
